...
// Using inline SVGs for icons to avoid extra dependencies or file loading.
// These are simple icons from libraries like Heroicons.
...
export const IconAssistant = (props: React.SVGProps<SVGSVGElement>) => (
 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const IconLoading = (props: React.SVGProps<SVGSVGElement>) => (
